...
const GenerateProgramPage = () => {
    ...
    // Fix the "Meeting has ended" error
    useEffect(() => {
    ...
    return (
        <div className='"flex flex-col min-h-screen text-foreground overflow-hidden pb-6 pt-2'>
            <div className='"container mx-auto px-4 h-full max-w-5x'>
                {/* TITLE */}
